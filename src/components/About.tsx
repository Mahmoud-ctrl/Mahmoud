  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-1/4 w-48 h-48 md:w-96 md:h-96 bg-purple-500/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 md:w-96 md:h-96 bg-blue-500/20 rounded-full blur-3xl"></div>
      </div>
          ...
          >
            ...
            <div className="text-gray-300 leading-relaxed font-bold">
              ...
              <div className=" lg:block text-3xl xl:text-4xl 2xl:text-[62px] leading-tight">
                ...
                <RotatingText
                  texts={['optimized', 'scalable', 'intuitive', 'modern', 'efficient']}
