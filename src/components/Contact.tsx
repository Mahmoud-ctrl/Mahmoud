          ...
          <motion.div variants={itemVariants} className="lg:col-span-1 space-y-6">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-white font-semibold">Call Me</h3>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400"><a href="mailto:baderaldinmahmud@gmail.com">baderaldinmahmud@gmail.com</a></p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Open for freelance or full-time projects</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
